...
CMN_SRC = uCmdLineUtils.pas uCommonUtils.pas uGenLexer.pas uNBCLexer.pas uNXCLexer.pas uVersionInfo.pas mwGenericLex.pas ParamUtils.pas
...
EXTRA_DIST = nxt/nbclinux.mak nxt/nbcmac.mak nxt/nbcfreebsd.mak nxt/nbcdelphi.mak nxt/nbcwin32.mak nxt/nbcwincearm.mak nxt/NBCCommon.h nxt/NXTDefs.h nxt/NXCDefs.h nxt/struct.nxc nxt/bools.nbc nxt/test.nxc nxt/test.npg bricxcc.mak nxt/history.txt nxt/readme.txt
DISTFILES = $(NBC_SRC) $(NXT_SRC) $(CMN_SRC) $(CMN_SRC2) $(BT_SRC) $(FANTOM_SRC) $(RIC_SRC) $(EXTRA_DIST)
BINDIST = nxt/nbc nxt/history.txt nxt/readme.txt nxt/struct.nxc

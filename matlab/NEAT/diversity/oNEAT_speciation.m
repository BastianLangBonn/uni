%% oNEAT_speciation.m - Original NEAT speciation, aka first compatible seed
%
%   Procedure:
...
if isempty(species)
    ...
    for i=1:length(prevSpecies)
       ...
       % These values will be removed, but MATLAB gets cranky with
       % uninitialized structs sometimes
